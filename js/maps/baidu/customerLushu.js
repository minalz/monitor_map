    ...
    baidu.object.extend(LuShu.prototype, {
        ...
        _move: function(initPos,targetPos,effect) {
            var me = this,
                ...
                // 两点间的距离
                distance = me._getDistance(init_pos, target_pos),
                // 因为这里使用了步长来使得marker匀速 获得视觉上的好的体验 所以会有点误差 但是下面的方法计算出的距离也是正确的
//                distance2 = map.getDistance(initPos, targetPos);
                //总的步长
                count = Math.round(distance / step);
//                count = Math.round(me._getDistance(init_pos, target_pos) / step);
            totalDistance += distance;
            this._opts.defaultContent = "<font color='red'>" + (totalDistance/1000).toFixed(2) + "</font>&nbsp;KM";
